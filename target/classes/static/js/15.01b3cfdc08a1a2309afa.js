...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-68e2f60b","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/Bbs/Questiondetail.vue
...
/* scopeId */
var __vue_scopeId__ = "data-v-68e2f60b"
...
/* harmony default export */ __webpack_exports__["a"] = (_data$computed$method = {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                _context.next = 7;
                return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["U" /* getCancelLikeAnswer */])({ answerId: value.answerId });
              ...
              case 11:
                _context.next = 13;
                return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["T" /* getAnswerSupport */])({ answerId: value.answerId });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["X" /* getQuestCollectionDelete */])({ questionId: questionId });
              ...
              case 7:
                _context2.next = 9;
                return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["W" /* getQuestCollection */])({ questionId: questionId });
        ...
        return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 8:
                _context3.next = 10;
                return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["Q" /* UploadAnswer */])({
        ...
        return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["P" /* ShowQuestionByPage */])("" + _this4.questionData.articleId, val);

              case 2:
                result = _context4.sent;

                if (result["data"].code == "200") {
                  _this4.answerData = result["data"].result;
                }
        ...
        return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _context5.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["o" /* DeleteAnswer */])({ answerId: value.answerId });
  ...
  Eyeloading: function Eyeloading() {
    return __webpack_require__.e/* import() */(49).then(__webpack_require__.bind(null, "usp/"));
  }
        ...
        switch (_context6.prev = _context6.next) {
          ...
          case 7:
            ...
            if (__WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_json_stringify___default()(_this6.$route.params) === "{}") {
              ...
              questionId = _this6.$route.params.title;
              //正常请求
            }
            _context6.next = 11;
            return Object(__WEBPACK_IMPORTED_MODULE_4__api_data__["Y" /* getQuestion */])("" + questionId);

          case 11:
            result = _context6.sent;

            console.log(result);
            _this6.questionData = result["data"].result.data[0];
            _this6.answerData = result["data"].result.data[1];
            // this.answerNum = result["data"].result[1].length;
            _this6.SupportFlay = result["data"].result.data[1].hasLike;
            //判断是否收藏
            ...
            //判断是否点赞
            if (result["data"].result.data[0].hasFocus) {
              $(".question_operation li:nth-of-type(1)").css("color", "#409EFF");
              $(".question_support").attr("src", "../../../static/images/campus/detail/article_aftersupport.png");
            }
            //判断是否为回答者
            _this6.answerData.forEach(function (value, index) {
              if (value.userId != _this6.$GetUserId()) {
                $(".reply_operation").eq(index).find("li:last-of-type").remove();
              }
            });
...
//# sourceMappingURL=15.01b3cfdc08a1a2309afa.js.map