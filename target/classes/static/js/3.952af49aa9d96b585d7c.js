...
/* scopeId */
var __vue_scopeId__ = "data-v-7fe47d4a"
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api_data__["s" /* DeletecommentArticle */])({ commentId: value.commentId });
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                _context2.next = 3;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api_data__["j" /* CollectionArticles */])({
                  articleId: val
                });
              ...
              case 8:
                _context2.next = 10;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api_data__["i" /* CollectionArticledelete */])({ articleId: val });

              case 10:
                _result = _context2.sent;

                if (_result["data"].code == "200") {
                  _this2.message("success", "取消收藏");
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee3$(_context3) {
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                _context3.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api_data__["H" /* ShowAllCommentByPage */])("" + _this3.articleId + ("/" + val) + "/10");

              case 2:
                result = _context3.sent;

                console.log(result);
                _this3.commentData = result["data"].result.data;
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                _context4.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api_data__["m" /* CommentArticleLike */])({ commentId: value.commentId });
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                _this5.pushLoading = true;
                _context5.next = 3;
                return Object(__WEBPACK_IMPORTED_MODULE_2__api_data__["l" /* CommentArticleInsert */])({
                  articleId: _this5.articleData.articleId,
              ...
              case 3:
                ...
                if (result["data"].code == "200") {
                  ...
                  _this5.total++;
                  _this5.pushLoading = false;
                  date = new Date();

                  if (_this5.commentData.length < 10) {
                    _this5.commentData.unshift({
                      likeNum: 0,
                      ...
                      authorName: _this5.$store.state.user.userName,
                      authorImage: _this5.$store.state.user.selfImage
                    });
                  } else {
                    _this5.commentData.pop();
                    _this5.commentData.unshift({
                      likeNum: 0,
    ...
    return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return Object(__WEBPACK_IMPORTED_MODULE_3__api_data__["K" /* ShowArticle */])(id);
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              //请求评论
              _context.next = 5;
              return Object(__WEBPACK_IMPORTED_MODULE_3__api_data__["H" /* ShowAllCommentByPage */])("" + id + '/1/10');
            ...
            case 5:
              ...
              getArticle(id).then(function (res) {
                ...
                //判断是否为作者
                if (_this.$GetUserId() == _this.articleData.userId) {
                  _this.authorEnum = true;
                } else {
                  _this.authorEnum = false;
                }
                //判断是否为评论人
                _this.commentData.forEach(function (value, index) {
                  if (value.userId != _this.$GetUserId()) {
                    console.log(index);
                    $(".comment_operation").eq(index).find("li:last-of-type").remove();
                  }
                });
              });
...
//# sourceMappingURL=3.952af49aa9d96b585d7c.js.map