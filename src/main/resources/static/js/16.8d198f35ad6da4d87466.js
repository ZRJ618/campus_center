...
/* scopeId */
var __vue_scopeId__ = "data-v-77776fce"
        ...
        return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Object(__WEBPACK_IMPORTED_MODULE_3__api_data__["v" /* FocusOther */])({
                  userId: value.userId
                });
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                _context3.next = 4;
                return Object(__WEBPACK_IMPORTED_MODULE_3__api_data__["O" /* ShowFocusByPage */])({
                  pageNum: val,
                  pageSize: 8
                });
              ...
              case 8:
                _context3.next = 10;
                return Object(__WEBPACK_IMPORTED_MODULE_3__api_data__["M" /* ShowFansByPage */])({
                  pageNum: val,
                  pageSize: 8
                });
          ...
          return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee4$(_context4) {
            while (1) {
              switch (_context4.prev = _context4.next) {
                case 0:
                  _context4.next = 2;
                  return Object(__WEBPACK_IMPORTED_MODULE_3__api_data__["N" /* ShowFocus */])();
          ...
          return __WEBPACK_IMPORTED_MODULE_1_babel_runtime_regenerator___default.a.wrap(function _callee5$(_context5) {
            while (1) {
              switch (_context5.prev = _context5.next) {
                case 0:
                  _context5.next = 2;
                  return Object(__WEBPACK_IMPORTED_MODULE_3__api_data__["L" /* ShowFans */])();
          ...
          switch (_context6.prev = _context6.next) {
            case 0:
              ...
              __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.all([p1, p2]).then(function (res) {
                _this4.MycareData = res[0]["data"].result;
                _this4.CaremyData = res[1]["data"].result;
                console.log(res);
              });
...
//# sourceMappingURL=16.8d198f35ad6da4d87466.js.map