        ...
        return regenerator_default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.next = 2;
                return Object(data["t" /* DeleteHistory */])({ scanHistoryId: id.articleId });
        ...
        return regenerator_default.a.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return Object(data["N" /* ShowAllLimitTimeByPage */])(val);

              case 2:
                result = _context2.sent;

                //  this.list=result["data"].result;
                _this2.list = result["data"].result.data;
                console.log(result);
      ...
      return regenerator_default.a.wrap(function _callee3$(_context3) {
        while (1) {
          switch (_context3.prev = _context3.next) {
            case 0:
              _context3.next = 2;
              return Object(data["N" /* ShowAllLimitTimeByPage */])(1);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-48a3d67a","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/Bbs/Track.vue
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',[_vm._m(0),_vm._v(" "),(_vm.total!=0)?_c('div',{staticClass:"Track_container"},[_c('span',{staticClass:"Track_tis"},[_vm._v("只显示最近3天浏览记录")]),_vm._v(" "),_vm._l((_vm.list),function(value,key){return _c('div',{key:key,staticClass:"Track_main"},[_c('span',[_vm._v(_vm._s(key + 1))]),_vm._v(" "),_c('span'),_vm._v(" "),_c('span',[_vm._v(_vm._s(value.time)+"浏览了"+_vm._s(value.title))]),_vm._v(" "),_c('el-tooltip',{attrs:{"content":"删除","placement":"top","effect":"light"}},[_c('span',{staticClass:"el-icon-delete",on:{"click":function($event){return _vm.handleDelete(value,key)}}})])],1)}),_vm._v(" "),_c('div',{staticClass:"Delete_btn"},[_c('el-button',{attrs:{"size":"mini","icon":"el-icon-delete"}},[_vm._v("删除全部")])],1),_vm._v(" "),_c('div',{staticClass:"block"},[_c('el-pagination',{staticStyle:{"text-align":"center"},attrs:{"current-page":_vm.currentPage1,"page-size":9,"layout":"total, prev, pager, next","total":_vm.total},on:{"size-change":_vm.handleSizeChange,"current-change":_vm.handleCurrentChange,"update:currentPage":function($event){_vm.currentPage1=$event},"update:current-page":function($event){_vm.currentPage1=$event}}})],1)],2):_c('div',{staticClass:"Track_null"},[_c('span',[_vm._v("空空如也 ")]),_c('router-link',{attrs:{"to":"/campus/hotlist"}},[_vm._v("去逛逛")])],1)])}
...
/* scopeId */
var __vue_scopeId__ = "data-v-48a3d67a"
...
//# sourceMappingURL=39.40dd2c2900d49bb6cd4b.js.map