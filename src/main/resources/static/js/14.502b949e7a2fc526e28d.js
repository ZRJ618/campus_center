...
/* harmony default export */ __webpack_exports__["a"] = ({
        ...
        data1: [{
          ...
          validator: function validator(rule, value, callback) {
            if (value == null) {
              ...
              var date1 = value[0];
              var data_Arr1 = date1.split(" ");
              var date_Arr2 = data_Arr1[0].split("-");
              var date_Arr3 = data_Arr1[1].split(":");
              DateFlay(date_Arr2, date_Arr3, callback);
              var date2 = value[1];

              var dateEnd = date2.split(" ");

              var date_Arr4 = dateEnd[0].split("-");
              ...
              if (enrollTime != "") {
                var enrollStart = enrollTime[1].split(" ");
                var enroll_Arr1 = enrollStart[0].split("-");
                var enroll_Arr2 = enrollStart[1].split(":");
        ...
        data2: [{
          ...
          validator: function validator(rule, value, callback) {
            ...
            if (value == null) {
              ...
              var date2 = value[1];
              var date_Arr4 = date2.split(" ");
              var date_Arr5 = date_Arr4[0].split("-");
              var date_Arr6 = date_Arr4[1].split(":");
              DateFlay(date_Arr2, date_Arr3, callback);
              enrollTime = value;
              if (activityTime != "") {
                var activityStart = activityTime.split(" ");
                var activity_Arr1 = activityStart[0].split("-");
                var activity_Arr2 = activityStart[1].split(":");
              ...
              return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      _context.next = 2;
                      return Object(__WEBPACK_IMPORTED_MODULE_2__api_data__["b" /* AddActivity */])({
  ...
  watch: {
    type: function type(newV, orderV) {
      console.log(newV);
      console.log(orderV);
    }
  }
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/template-compiler?{"id":"data-v-95a13c78","hasScoped":true,"transformToRequire":{"video":["src","poster"],"source":"src","img":"src","image":"xlink:href"},"buble":{"transforms":{}}}!./node_modules/vue-loader/lib/selector.js?type=template&index=0!./src/components/Department/CreateAcvitity.vue
...
/* scopeId */
var __vue_scopeId__ = "data-v-95a13c78"
...
//# sourceMappingURL=14.502b949e7a2fc526e28d.js.map